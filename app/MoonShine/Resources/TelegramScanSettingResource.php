...
class TelegramScanSettingResource extends ModelResource
{
    ...
    {
        return [ID::make(), Switcher::make('Schedule', 'schedule_enabled'), Number::make('Every min', 'interval_minutes'), Number::make('Delay s', 'channel_delay_seconds'), Number::make('Posts', 'scan_limit'), Switcher::make('Comments', 'with_comments'), Number::make('Comments limit', 'comments_limit'), Date::make('Last dispatch', 'last_dispatched_at')->format('Y-m-d H:i')];
    }

...
class TelegramChannelResource extends ModelResource
{
    ...
    {
        return [ID::make()->sortable(), Text::make('Name', 'name')->sortable(), Text::make('Username', 'username'), Url::make('URL', 'url')->blank(), Switcher::make('Active', 'active'), Date::make('Last scan', 'last_scan_at')->format('Y-m-d H:i')];
    }
